...
const LeadershipSection = () => (
    <section className="relative bg-gradient-to-b from-white via-pink-50 to-orange-50 py-20 px-4 sm:px-6 lg:px-12 xl:px-20 font-sans overflow-hidden">
        {/* Glow background */}
        ...
        <div className="text-center mb-14 relative z-10">
            <motion.h2
                ...
                viewport={{ amount: 0.3 }}
            >
                My Approach to <span className="relative inline-block text-orange-400">Leadership</span>
            </motion.h2>
            <motion.p
                ...
                viewport={{ amount: 0.3 }}
            >
                I believe in leading with integrity, empowering others, and inspiring through action. These values guide how I show up, collaborate, and create meaningful impact.
            </motion.p>
        </div>
        ...
        >
                ...
                {cards.map((card, i) => (
                    <motion.div key={i} variants={cardVariants}>
                        ...
                        >
                            ...
                            <div className="ml-12">
                                <CardTitle className={`text-xl font-semibold mb-2 ${card.textColor}`}>
                                    {card.title}
                                </CardTitle>
                                <CardContent className={`p-0 text-sm leading-relaxed ${card.subColor}`}>
                                    {card.desc}
                                </CardContent>
                            </div>
                        </Card>
            ...
            >
                ...
                />
                <motion.div className="absolute inset-0 bg-gradient-to-t from-black/60 via-black/30 to-transparent flex items-end justify-start p-6 opacity-0 hover:opacity-100 transition-opacity duration-500">
                    <div>
                        <h3 className="text-white text-xl font-semibold">Leading with Purpose</h3>
                        <p className="text-gray-200 text-sm mt-2 max-w-sm">
                            Every action I take reflects my values of integrity, empowerment, and inspiration.
                        </p>
                    </div>
                </motion.div>
            </motion.div>
